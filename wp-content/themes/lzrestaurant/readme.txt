...
1. Go to Customizer >> Theme Settings >> Social Icon Section, add social icon urls.

For Slider:
============

1. Go to Dashboard >> Pages >> Add New, Create a new Page and name it, add the content, featured image and publish the page.
...
= 1.7.5 =
	...
	- Added Products section padding option.
...
= 1.8.3 =
	- Changed footer background image.
...
= 1.8.5 =
	- Added Footer Copyright Text & Link Option in Customizer.
	- Fixed Minor Bugs.

= 1.8.6 =
	- Added color options in customizer.

= 1.8.7 =
	- Added more color option for all sections in customizer.
	- Fixed slider image size.
	- Fixed some errors.

= 1.8.8 =
	- Added more color option for site title tagline in customizer.
...
= 1.9.2 =
	...
	- Added title and content font size option in customizer.
	- Added box width and full width option in customizer.
	- Added image height option in customizer.

= 1.9.3 =
	- Added feature section title and content font size option in customizer.
	- Minor changes were made.

= 1.9.4 =
	- Added font size option product title in customizer.
