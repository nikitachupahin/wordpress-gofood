...
function lzrestaurant_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('lzrestaurant_logo_size',array(
		'default' => '',
		'sanitize_callback'	=> 'lzrestaurant_sanitize_float'
	));
	$wp_customize->add_control('lzrestaurant_logo_size',array(
		'type' => 'range',
		'description' => __('Logo Size (0-100%)','lzrestaurant'),
	...
	$wp_customize->add_setting( 'lzrestaurant_dropdown_anim', array(
		'default'           => 'None',
		'sanitize_callback' => 'lzrestaurant_sanitize_choices'
	));
	$wp_customize->add_control( 'lzrestaurant_dropdown_anim', array(
		'label'    => __( 'Menu Dropdown Animations', 'lzrestaurant' ),
		'section'  => 'lzrestaurant_theme_options_section',
		'type'     => 'select',
		'choices'  => array(
			'bounceInUp'  => __('bounceInUp', 'lzrestaurant'),
			'fadeInUp' => __('fadeInUp', 'lzrestaurant'),
			'zoomIn'    => __('zoomIn', 'lzrestaurant'),
			'None'    => __('None', 'lzrestaurant')
		),
	));
   ...
   //Social Icons(topbar)
	...
	$wp_customize->add_setting( 'lzrestaurant_slider_effect', array(
		'default'           => '',
		'sanitize_callback' => 'lzrestaurant_sanitize_choices'
	));
	$wp_customize->add_control( 'lzrestaurant_slider_effect', array(
		'label'    => __( 'Onload Transactions Effects', 'lzrestaurant' ),
		'section'  => 'lzrestaurant_slider_section',
		'type'     => 'select',
		'choices'  => array(
			'bounceInLeft'  => __('bounceInLeft', 'lzrestaurant'),
			'bounceInRight' => __('bounceInRight', 'lzrestaurant'),
			'bounceInUp'    => __('bounceInUp', 'lzrestaurant'),
			'bounceInDown'    => __('bounceInDown', 'lzrestaurant'),
			'zoomIn'  => __('zoomIn', 'lzrestaurant'),
			'zoomOut' => __('zoomOut', 'lzrestaurant'),
			'fadeInDown'    => __('fadeInDown', 'lzrestaurant'),
			'fadeInUp'    => __('fadeInUp', 'lzrestaurant'),
			'fadeInLeft'  => __('fadeInLeft', 'lzrestaurant'),
			'fadeInRight' => __('fadeInRight', 'lzrestaurant'),
			'flip-up'    => __('flip-up', 'lzrestaurant'),
			'none'    => __('none', 'lzrestaurant')
		),
	));
	...
	$wp_customize->add_setting('lzrestaurant_slider_title_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'lzrestaurant_sanitize_float'
	));
	$wp_customize->add_control('lzrestaurant_slider_title_font_size',array(
		'type' => 'number',
		'label' => __('Slider Title Font Size','lzrestaurant'),
		'section' => 'lzrestaurant_slider_section',
	));

	$wp_customize->add_setting('lzrestaurant_slider_text_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'lzrestaurant_sanitize_float'
	));
	$wp_customize->add_control('lzrestaurant_slider_text_font_size',array(
		'type' => 'number',
		'label' => __('Slider Text Font Size','lzrestaurant'),
		'section' => 'lzrestaurant_slider_section',
	));
   ...
   $wp_customize->add_section( 'lzrestaurant_product', array(
	...
	$wp_customize->add_setting( 'lzrestaurant_product_width', array(
		'default'           => '',
		'sanitize_callback' => 'lzrestaurant_sanitize_choices'
	));
	$wp_customize->add_control( 'lzrestaurant_product_width', array(
		'label'    => __( 'Box width and Full Width', 'lzrestaurant' ),
		'section'  => 'lzrestaurant_product',
		'type'     => 'select',
		'choices'  => array(
			'container'  => __('container', 'lzrestaurant'),
			'container-fluid' => __('container-fluid', 'lzrestaurant')
		),
	));
   ...
   $wp_customize->add_setting('lzrestaurant_title',array(
	...
	$wp_customize->add_setting('lzrestaurant_feature_short_title_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'lzrestaurant_sanitize_float'
	));
	$wp_customize->add_control('lzrestaurant_feature_short_title_font_size',array(
		'type' => 'number',
		'label' => __('Short Title Font Size','lzrestaurant'),
		'section' => 'lzrestaurant_product',
	));

	$wp_customize->add_setting('lzrestaurant_feature_title_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'lzrestaurant_sanitize_float'
	));
	$wp_customize->add_control('lzrestaurant_feature_title_font_size',array(
		'type' => 'number',
		'label' => __('Title Font Size','lzrestaurant'),
		'section' => 'lzrestaurant_product',
	));
	...
	$wp_customize->add_setting('lzrestaurant_product_title_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'lzrestaurant_sanitize_float'
	));
	$wp_customize->add_control('lzrestaurant_product_title_font_size',array(
		'type' => 'number',
		'label' => __('Product Title Font Size','lzrestaurant'),
		'section' => 'lzrestaurant_product',
	));
	...
	$wp_customize->add_setting('lzrestaurant_product_img_hight',array(
		'default' => '',
		'sanitize_callback'	=> 'lzrestaurant_sanitize_float'
	));
	$wp_customize->add_control('lzrestaurant_product_img_hight',array(
		'type' => 'number',
		'label' => __('Image Height','lzrestaurant'),
		'section' => 'lzrestaurant_product',
	));
   ...
   $wp_customize->add_setting('lzrestaurant_footer_copy',array(
	...
	$wp_customize->add_setting('lzrestaurant_copyright_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'lzrestaurant_sanitize_float'
 	));
 	$wp_customize->add_control('lzrestaurant_copyright_font_size',array(
		'type' => 'number',
		'label' => __('Font Size','lzrestaurant'),
		'section' => 'lzrestaurant_footer',
	));
