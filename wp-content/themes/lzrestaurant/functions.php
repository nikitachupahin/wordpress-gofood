...
function lzrestaurant_scripts() {
	...
	wp_add_inline_style( 'lzrestaurant-basic-style',$lzrestaurant_custom_style );
...
function lzrestaurant_sanitize_float( $input ) {
    return filter_var($input, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
}

//footer Link
define('LZRESTAURANT_LIVE_DEMO',__('https://www.luzukdemo.com/demo/lz-restaurant/','lzrestaurant'));
define('LZRESTAURANT_PRO_DOCS',__('https://www.luzukdemo.com/docs/lz-restaurant/','lzrestaurant'));
...
/* Breadcrumb Begin */
function lzrestaurant_breadcrumb() {
	if (!is_home()) {
		echo '<a href="';
