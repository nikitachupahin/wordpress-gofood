	...
	<main id="tp_content" role="main">
		<div id="primary" class="content-area">
			<div class="page-header">
				<?php if ( have_posts() ) : ?>
					<h1 class="page-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s', 'restaurant-fast-food' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
				<?php else : ?>
					<h1 class="page-title"><?php echo esc_html(get_theme_mod('restaurant_fast_food_edit_no_result_title',__('Nothing Found','restaurant-fast-food')));?></h1>
				<?php endif; ?>
			</div>		
			<?php
	        $restaurant_fast_food_sidebar_layout = get_theme_mod( 'restaurant_fast_food_sidebar_post_layout','right');
	        if($restaurant_fast_food_sidebar_layout == 'left'){ ?>
		        <div class="row m-0">
		          	...
		          	<div class="col-lg-8 col-md-8">
			            ...
			            <?php if ( have_posts() ) :
							...
							endwhile; // End of the loop.
								...
								<p><?php echo esc_html(get_theme_mod('restaurant_fast_food_edit_no_result_text',__('Sorry, but nothing matched your search terms. Please try again with some different keywords.','restaurant-fast-food')));?></p>
								<?php
									get_search_form();
		        ...
		        <div class="clearfix"></div>
		    <?php }else if($restaurant_fast_food_sidebar_layout == 'right'){ ?>
		        <div class="row m-0">
		          	<div class="col-lg-8 col-md-8">
		    ...
		    <?php }else if($restaurant_fast_food_sidebar_layout == 'full'){ ?>
		        <div class="full">
		    ...
		    <?php }else if($restaurant_fast_food_sidebar_layout == 'three-column'){ ?>
		        <div class="row m-0">
		    ...
		    <?php }else if($restaurant_fast_food_sidebar_layout == 'four-column'){ ?>
		        <div class="row m-0">
		    ...
		    <?php }else if($restaurant_fast_food_sidebar_layout == 'grid'){ ?>
		        <div class="row m-0">
