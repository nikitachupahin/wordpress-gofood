...
if ( ! class_exists( 'Restaurant_Fast_Food_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Restaurant_Fast_Food_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Restaurant_Fast_Food_WPTT_WebFont_Loader( $url );
